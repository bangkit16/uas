...
<body>
    ...
    <div class="container">
        ...
        ?>
        <div class="card  text-white" style="border-radius: 1rem;background-color: rgba(25, 25, 25, 0.8);padding : 10px">
            <form action="updateProses.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="form-outline form-white mb-4 ">
                            <input type="text" value="<?= $row['nama']; ?>" name="nama" id="Usernamex" class="form-control form-control-lg " />
                        </div>
                    </div>
                    <div class="col">
                        <h2>Kategori</h2>
                        <div class="form-outline form-white mb-4 ">
                            <input type="text" value="<?= $row['kategori']; ?>" name="kategori" id="Emailx" class="form-control form-control-lg " />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <h2>Deskripsi</h2>
                        <div class="form-outline form-white mb-4 ">
                            <textarea rows="4" cols="50" value="<?= $row['deskripsi']; ?>" name="deskripsi" id="Addressx" class="form-control form-control-lg "></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-outline form-white mb-4 ">
                            <input type="number" value="<?= $row['harga']; ?>" name="harga" id="PhoneNumberx" class="form-control form-control-lg " min="0" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <h2>Gambar Cover</h2>
                        <div class="form-outline form-white mb-4 ">
                            <input type="file" value="<?= $row['gambarCover']; ?>" name="cover" id="Usernamex" class="form-control form-control-lg " />
                        </div>
                    </div>
                    <div class="col">
                        <h2>Gambar Game</h2>
                        <div class="form-outline form-white mb-4 ">
                            <input type="file" value="<?= $row['gambar1']; ?>" name="gambar" id="Emailx" class="form-control form-control-lg " />
                        </div>
                    </div>
                </div>
                <div class="row">
